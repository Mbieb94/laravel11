    ...
    <div class="toolbar d-flex align-items-stretch">
        ...
        <div class="container-xxl py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
            ...
            <div class="page-title d-flex justify-content-center flex-column me-5">
                <!--begin::Title-->
                <h1 class="d-flex flex-column text-gray-900 fw-bold fs-3 mb-0">{{ ucwords(str_replace(['-', '_'], ' ', request()->segment(1))) }}</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                    ...
                    @foreach (request()->segments() as $segment)
                        @if (is_numeric($segment)) @continue @endif
                        ...
                        <li class="breadcrumb-item {{ $loop->last ? 'text-gray-900' : 'text-muted' }}">
                            @if ($loop->first)
                                <a href="{{ url(request()->segment(1)) }}"
                                    class="ttext-muted ext-hover-primary">{{ __(ucwords(str_replace('_', ' ', $segment))) }}</a>
                            @else
